...
import { formatCellValue } from '@/lib/cellFormatters';
...
const ExcelCell = memo(({ 
    ...
    const {
        ...
        cancelEdit,
        handleKeyDown
    } = useExcelCell(cellId, value, onUpdate, onNavigate);
    ...
    const cellStyles = {
        ...
        ...((!isInRange || isSelected) && { backgroundColor: format.backgroundColor || '#ffffff' }),
    ...
    const displayValue = isEditing ? editValue : formatCellValue(value, format.format || 'text');
