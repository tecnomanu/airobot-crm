...
export const getLeadsManagerColumns = (
    handleDelete,
    handleRetry,
    handleCall,
    handleWhatsApp
    ...
    },
    {
        ...
        header: "Cliente",
        cell: ({ row }) => {
            const client = row.original.campaign?.client || row.original.client;
    ...
    },
    {
        ...
        header: "Intención",
        cell: ({ row }) => {
            const status = row.original.intention_status;
            ...
            return (
                <Badge className={colors[status] || "bg-gray-100 text-gray-800"}>
                    {row.original.intention_status_label || status}
                </Badge>
            );
        },
    },
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    onClick={() =>
                                        router.visit(
                                            route("leads-manager.show", lead.id)
                                        )
                                    }
                                    className="h-8 w-8"
                                >
