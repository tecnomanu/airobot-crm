...
class ReportingController extends Controller
{
    ...
    public function globalMetrics(): JsonResponse
    {
        ...
        return $this->successResponse(
            new GlobalMetricsResource($metrics),
            'Global metrics retrieved successfully'
        );
    }
     ...
     */
    public function clientMonthlySummary(Request $request, string $clientId): JsonResponse
    {
     ...
     */
    public function clientOverview(string $clientId): JsonResponse
    {
        $client = $this->clientService->getClientById($clientId);
